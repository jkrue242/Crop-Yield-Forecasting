...
class ConvEncoder(nn.Module):
    def __init__(self, input_channels, latent_dim=12, kernel_size=[4, 4], strides=[1, 1], n_channels=[32, 128]):
        super().__init__()
...
class ConvDecoder(nn.Module):
    def __init__(self, output_channels, output_size=(8, 8), latent_dim=12, flatten_shape=[4, 4, 128],
...
class SOMVAE(nn.Module):
    def __init__(self, encoder, decoder_q, decoder_e, latent_dim=12, som_dim=[8,8],
                 input_length=9, input_channels=9, beta=1, gamma=1, alpha=1, tau=1):
        super().__init__()
